...
function loadJtaBuffer(aBuffer) {
...
function loadPackage(aBuffer, path) {
    ...
    for (i = 0; i < cnt; i++) {
        ...
        let pi = _itemsById[buffer.readS()];
        let rect = new Rect();
...
module.exports = { LoadPackage: loadPackage, LoadJta: loadJtaBuffer }