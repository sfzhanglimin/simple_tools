...
declare module 'fairygui-cc/GObject' {
    ...
    import { Event } from "fairygui-cc/event/Event";
    ...
    export class GObject {
        ...
        get packageItem(): PackageItem;
        set packageItem(v: PackageItem);
        constructor();
        get id(): string;
        get name(): string;
        ...
        set pivotAsAnchor(value: boolean);
        ...
        /**add by zlm  */
        LocalToRoot(aPos?: Vec2): Vec2;
        localToGlobal(ax?: number, ay?: number, result?: Vec2): Vec2;
        /**add by zlm  */
        RootToLocal(aPos?: Vec2): Vec2;
...
declare module 'fairygui-cc/GGraph' {
    ...
    export class GGraph extends GObject {
            ...
            /**
                ...
                * 不做update操作
                */
            protected setFColor(value: Color): void;
            /**
                * add by zlm
                * 不做update操作
                */
            protected setLColor(value: Color): void;
            protected handleSizeChanged(): void;
            protected handleAnchorChanged(): void;
            getProp(index: number): any;
            setProp(index: number, value: any): void;
...
declare module 'fairygui-cc/GRoot' {
    ...
    export class GRoot extends GComponent {
        ...
        playOneShotSound(clipPath: string, volumeScale?: number): void;
        onWinResize(): void;
        handlePositionChanged(): void;
    }
}
...
declare module 'fairygui-cc/GLoader3D' {
    ...
    export class GLoader3D extends GObject {
        ...
        get color(): Color;
        set color(value: Color);
        get content(): sp.Skeleton | dragonBones.ArmatureDisplay | ParticleSystem2D;
        protected loadContent(): void;
        protected loadFromPackage(itemURL: string): void;
        /**add by zlm */
        setParcitle(asset: ParticleAsset, anchor: Vec2): void;
        onChangeParcitle(): void;
        freeParcitle(): void;
        /**只对parcitle有效 */
...
declare module 'fairygui-cc/GComponent' {
    ...
    export class GComponent extends GObject {
        ...
        /**add by zlm */
        setupOverflowHidden(value: boolean): void;
        protected handleAnchorChanged(): void;
        protected handleSizeChanged(): void;
        protected handleGrayedChanged(): void;
        handleControllerChanged(c: Controller): void;
...
declare module 'fairygui-cc/Transition' {
    ...
    export class Transition {
        ...
        play(onComplete?: (() => void) | null): void;
        play(times?: number, delay?: number, onComplete?: (() => void) | null): void;
        play(times?: number, delay?: number, startTime?: number, endTime?: number, onComplete?: (() => void) | null): void;
...
declare module 'fairygui-cc/UIPackage' {
    ...
    export class UIPackage {
            ...
            /**add by zlm */
            static addPackage(bundleName: string, path: string): UIPackage;
            static addPackage(bundle: AssetManager.Bundle, path: string): UIPackage;
            /**add by zlm */
            static AddPackage(sepStr: string): UIPackage;
            /**
...
declare module 'fairygui-cc/UIConfig' {
    ...
    export class UIConfig {
        ...
        static onMusicCallback: (path: string, volume: number) => boolean;
    }
...
declare module 'fairygui-cc/tween/GTween' {
    ...
    export class GTween {
        ...
        static To(start: any, end: any, duration: number): GTweener;
        static ToDouble(start: number, end: number, duration: number): GTweener;
        ...
        static shake(startXY: {
            x: number;
            y: number;
        }, amplitude: number, duration: number): GTweener;
