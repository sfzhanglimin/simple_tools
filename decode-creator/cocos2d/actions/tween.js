...
const bezier_1 = require("../animation/bezier");
let _tweenID = 0;
...
Object.assign(Tween.prototype, {
    ...
    bezierTo(duration, c1, c2, to, opts) {
        let c0x = c1.x, c0y = c1.y, c1x = c2.x, c1y = c2.y;
        opts = opts || Object.create(null);
        opts.progress = function (start, end, current, t) {
            current.x = (0, bezier_1.bezier)(start.x, c0x, c1x, end.x, t);
            current.y = (0, bezier_1.bezier)(start.y, c0y, c1y, end.y, t);
            return current;
        };
    ...
    bezierBy(duration, c1, c2, to, opts) {
        ...
        opts.progress = function (start, end, current, t) {
            ...
            current.x = (0, bezier_1.bezier)(sx, c0x + sx, c1x + sx, end.x, t);
            current.y = (0, bezier_1.bezier)(sy, c0y + sy, c1y + sy, end.y, t);
            return current;
        };
