...
const memop_1 = require("../memop");
const enums_1 = __importDefault(require("../enums"));
const value_types_1 = require("../../core/value-types");
const program_lib_1 = __importDefault(require("./program-lib"));
const view_1 = __importDefault(require("./view"));
const gfx_1 = __importDefault(require("../gfx"));
let _m4_tmp = new value_types_1.Mat4();
let _stageInfos = new memop_1.RecyclePool(() => {
    return {
        stage: null,
        items: null,
    };
}, 8);
let _float2_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(2);
}, 8);
let _float3_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(3);
}, 8);
let _float4_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(4);
}, 8);
let _float9_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(9);
}, 8);
let _float16_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(16);
}, 8);
let _float64_pool = new memop_1.RecyclePool(() => {
    return new Float32Array(64);
}, 8);
let _int2_pool = new memop_1.RecyclePool(() => {
    return new Int32Array(2);
}, 8);
let _int3_pool = new memop_1.RecyclePool(() => {
    return new Int32Array(3);
}, 8);
let _int4_pool = new memop_1.RecyclePool(() => {
    return new Int32Array(4);
}, 8);
let _int64_pool = new memop_1.RecyclePool(() => {
...
class Base {
    ...
    constructor(device, opts) {
        this._device = device;
        this._programLib = new program_lib_1.default(device);
        this._opts = opts;
        this._type2defaultValue = {
            [enums_1.default.PARAM_INT]: 0,
            [enums_1.default.PARAM_INT2]: new value_types_1.Vec2(0, 0),
            [enums_1.default.PARAM_INT3]: new value_types_1.Vec3(0, 0, 0),
            [enums_1.default.PARAM_INT4]: new value_types_1.Vec4(0, 0, 0, 0),
            [enums_1.default.PARAM_FLOAT]: 0.0,
            [enums_1.default.PARAM_FLOAT2]: new value_types_1.Vec2(0, 0),
            [enums_1.default.PARAM_FLOAT3]: new value_types_1.Vec3(0, 0, 0),
            [enums_1.default.PARAM_FLOAT4]: new value_types_1.Vec4(0, 0, 0, 0),
            [enums_1.default.PARAM_COLOR4]: new value_types_1.Color(0, 0, 0, 1),
            [enums_1.default.PARAM_MAT3]: new value_types_1.Mat3(),
            [enums_1.default.PARAM_MAT4]: new value_types_1.Mat4(),
            [enums_1.default.PARAM_TEXTURE_2D]: opts.defaultTexture,
            [enums_1.default.PARAM_TEXTURE_CUBE]: opts.defaultTextureCube,
        };
        this._stage2fn = {};
        this._usedTextureUnits = 0;
        this._viewPools = new memop_1.RecyclePool(() => {
            return new view_1.default();
        }, 8);
        this._drawItemsPools = new memop_1.RecyclePool(() => {
            return {
                model: null,
                node: null,
                ia: null,
        ...
        this._stageItemsPools = new memop_1.RecyclePool(() => {
            return new memop_1.RecyclePool(() => {
                return {
                    model: null,
                    node: null,
                    ia: null,
    ...
    _render(view, scene) {
        ...
        // setup clear
        let clearOpts = {};
        if (view._clearFlags & enums_1.default.CLEAR_COLOR) {
            clearOpts.color = value_types_1.Vec4.toArray([], view._color);
        }
        if (view._clearFlags & enums_1.default.CLEAR_DEPTH) {
            clearOpts.depth = view._depth;
        }
        if (view._clearFlags & enums_1.default.CLEAR_STENCIL) {
    ...
    _setProperty(prop) {
        ...
        if (prop.type === enums_1.default.PARAM_TEXTURE_2D ||
            prop.type === enums_1.default.PARAM_TEXTURE_CUBE) {
    ...
    _draw(item) {
        ...
        device.setUniform('cc_matWorld', value_types_1.Mat4.toArray(_float16_pool.add(), _m4_tmp));
        // let wq = node.getWorldRotation(cc.quat());
        value_types_1.Mat4.invert(_m4_tmp, _m4_tmp);
        value_types_1.Mat4.transpose(_m4_tmp, _m4_tmp);
        device.setUniform('cc_matWorldIT', value_types_1.Mat4.toArray(_float16_pool.add(), _m4_tmp));
        // }
        ...
        for (let i = 0; i < passes.length; ++i) {
            ...
            if (pass._stencilTest === gfx_1.default.STENCIL_ENABLE) {
                // front
