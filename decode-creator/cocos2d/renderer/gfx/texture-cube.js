...
class TextureCube extends texture_1.default {
    /**
     * @constructor
     * @param {Device} device
    ...
    update(options) {
        ...
        if (options) {
            ...
            if (options.format !== undefined) {
                ...
                this._compressed =
                    (this._format >= enums_1.enums.TEXTURE_FMT_RGB_DXT1 && this._format <= enums_1.enums.TEXTURE_FMT_RGBA_PVRTC_4BPPV1) ||
                        (this._format >= enums_1.enums.TEXTURE_FMT_RGB_ETC2 && this._format <= enums_1.enums.TEXTURE_FMT_RGBA_ETC2) ||
                        (this._format >= enums_1.enums.TEXTURE_FMT_RGBA_ASTC_4X4 && this._format <= enums_1.enums.TEXTURE_FMT_SRGBA_ASTC_12X12);
            }
        ...
        let pot = (0, misc_1.isPow2)(this._width) && (0, misc_1.isPow2)(this._height);
        if (!pot) {
            genMipmaps = false;
        }
    ...
    updateSubImage(options) {
        let gl = this._device._gl;
        let glFmt = (0, enums_1.glTextureFmt)(this._format);
        gl.activeTexture(gl.TEXTURE0);
        gl.bindTexture(gl.TEXTURE_CUBE_MAP, this._glID);
    ...
    _setTexInfo() {
        ...
        if (!pot && (this._wrapS !== enums_1.enums.WRAP_CLAMP || this._wrapT !== enums_1.enums.WRAP_CLAMP)) {
            console.warn('WebGL1 doesn\'t support all wrap modes with NPOT textures');
            this._wrapS = enums_1.enums.WRAP_CLAMP;
            this._wrapT = enums_1.enums.WRAP_CLAMP;
        }
        ...
        gl.texParameteri(gl.TEXTURE_CUBE_MAP, gl.TEXTURE_MIN_FILTER, (0, enums_1.glFilter)(gl, this._minFilter, mipFilter));
        gl.texParameteri(gl.TEXTURE_CUBE_MAP, gl.TEXTURE_MAG_FILTER, (0, enums_1.glFilter)(gl, this._magFilter, -1));
