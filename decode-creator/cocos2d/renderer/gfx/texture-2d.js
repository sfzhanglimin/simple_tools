 ...
 */
class Texture2D extends texture_1.default {
    /**
     * @constructor
     * @param {Device} device
    ...
    _setTexInfo() {
        ...
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, (0, enums_1.glFilter)(gl, this._minFilter, mipFilter));
        gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, (0, enums_1.glFilter)(gl, this._magFilter, -1));
