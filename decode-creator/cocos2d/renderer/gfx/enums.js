...
exports.glTextureFmt = exports.glFilter = exports.attrTypeBytes = exports.enums = void 0;
...
function attrTypeBytes(attrType) {
    if (attrType === exports.enums.ATTR_TYPE_INT8) {
        return 1;
    }
    else if (attrType === exports.enums.ATTR_TYPE_UINT8) {
        return 1;
    }
    else if (attrType === exports.enums.ATTR_TYPE_INT16) {
        return 2;
    }
    else if (attrType === exports.enums.ATTR_TYPE_UINT16) {
        return 2;
    }
    else if (attrType === exports.enums.ATTR_TYPE_INT32) {
        return 4;
    }
    else if (attrType === exports.enums.ATTR_TYPE_UINT32) {
        return 4;
    }
    else if (attrType === exports.enums.ATTR_TYPE_FLOAT32) {
        return 4;
    }
...
function glTextureFmt(fmt) {
    ...
    if (result === undefined) {
        ...
        return _textureFmtGL[exports.enums.TEXTURE_FMT_RGBA8];
    }
    return result;
}
