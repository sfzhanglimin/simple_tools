...
let _m4_tmp = cc.mat4();
let _m3_tmp = value_types_1.Mat3.create();
...
function _computeSpotLightViewProjMatrix(light, outView, outProj) {
    ...
    value_types_1.Mat4.invert(outView, outView);
    // proj matrix
    value_types_1.Mat4.perspective(outProj, light._spotAngle * light._spotAngleScale, 1, light._shadowMinDepth, light._shadowMaxDepth);
}
function _computeDirectionalLightViewProjMatrix(light, outView, outProj) {
    ...
    value_types_1.Mat4.ortho(outProj, -halfSize, halfSize, -halfSize, halfSize, light._shadowMinDepth, light._shadowMaxDepth);
}
function _computePointLightViewProjMatrix(light, outView, outProj) {
    ...
    value_types_1.Mat4.perspective(outProj, (0, value_types_1.toRadian)(179), 1, light._shadowMinDepth, light._shadowMaxDepth);
}
/**
...
class Light {
    ...
    constructor() {
        this._poolID = -1;
        this._node = null;
        this._type = enums_1.default.LIGHT_DIRECTIONAL;
        this._color = new value_types_1.Vec3(1, 1, 1);
        this._intensity = 1;
        // used for spot and point light
        this._range = 1;
        // used for spot light, default to 60 degrees
        this._spotAngle = (0, value_types_1.toRadian)(60);
        this._spotExp = 1;
        // cached for uniform
        ...
        // shadow params
        this._shadowType = enums_1.default.SHADOW_NONE;
     ...
     */
    setColor(r, g, b) {
        value_types_1.Vec3.set(this._color, r, g, b);
    ...
    extractView(out, stages) {
        ...
        // clear opts
        value_types_1.Vec3.set(out._color, 1, 1, 1);
        out._depth = 1;
        out._stencil = 1;
        ...
        // view-projection
        value_types_1.Mat4.mul(out._matViewProj, out._matProj, out._matView);
        this._viewProjMatrix = out._matViewProj;
        value_types_1.Mat4.invert(out._matInvViewProj, out._matViewProj);
    ...
    _updateLightPositionAndDirection() {
        ...
        value_types_1.Mat3.fromMat4(_m3_tmp, _m4_tmp);
        value_types_1.Vec3.transformMat3(_transformedLightDirection, _forward, _m3_tmp);
        value_types_1.Vec3.toArray(this._directionUniform, _transformedLightDirection);
    ...
    _generateShadowMap(device) {
        this._shadowMap = new gfx_1.default.Texture2D(device, {
            width: this._shadowResolution,
            height: this._shadowResolution,
            format: gfx_1.default.TEXTURE_FMT_RGBA8,
            wrapS: gfx_1.default.WRAP_CLAMP,
            wrapT: gfx_1.default.WRAP_CLAMP,
        });
        this._shadowDepthBuffer = new gfx_1.default.RenderBuffer(device, gfx_1.default.RB_FMT_D16, this._shadowResolution, this._shadowResolution);
        this._shadowFrameBuffer = new gfx_1.default.FrameBuffer(device, this._shadowResolution, this._shadowResolution, {
