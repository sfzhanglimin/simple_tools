...
let VelocityOvertimeModule = (() => {
    let _classDecorators = [(0, CCClassDecorator_1.ccclass)('cc.VelocityOvertimeModule')];
    ...
    let _z_decorators;
    let _z_initializers = [];
    let _speedModifier_decorators;
    let _speedModifier_initializers = [];
    var VelocityOvertimeModule = _classThis = class {
        constructor() {
            /**
             ...
             */
            this.speedModifier = __runInitializers(this, _speedModifier_initializers, new curve_range_1.default());
            this.rotation = null;
        ...
        animate(p) {
            ...
            const vel = value_types_1.Vec3.set(_temp_v3, this.x.evaluate(normalizedTime, (0, value_types_1.pseudoRandom)(p.randomSeed + VELOCITY_OVERTIME_RAND_OFFSET)), this.y.evaluate(normalizedTime, (0, value_types_1.pseudoRandom)(p.randomSeed + VELOCITY_OVERTIME_RAND_OFFSET)), this.z.evaluate(normalizedTime, (0, value_types_1.pseudoRandom)(p.randomSeed + VELOCITY_OVERTIME_RAND_OFFSET)));
            if (this.needTransform) {
                value_types_1.Vec3.transformQuat(vel, vel, this.rotation);
            }
            value_types_1.Vec3.add(p.animatedVelocity, p.animatedVelocity, vel);
            value_types_1.Vec3.add(p.ultimateVelocity, p.velocity, p.animatedVelocity);
            value_types_1.Vec3.scale(p.ultimateVelocity, p.ultimateVelocity, this.speedModifier.evaluate(1 - p.remainingLifetime / p.startLifetime, (0, value_types_1.pseudoRandom)(p.randomSeed + VELOCITY_OVERTIME_RAND_OFFSET)));
        }
    };
    __setFunctionName(_classThis, "VelocityOvertimeModule");
    (() => {
        ...
        _speedModifier_decorators = [(0, CCClassDecorator_1.property)({
                type: curve_range_1.default,
                range: [-1, 1],
            })];
        ...
        __esDecorate(null, null, _speedModifier_decorators, { kind: "field", name: "speedModifier", static: false, private: false, access: { has: obj => "speedModifier" in obj, get: obj => obj.speedModifier, set: (obj, value) => { obj.speedModifier = value; } }, metadata: _metadata }, _speedModifier_initializers, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        VelocityOvertimeModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return VelocityOvertimeModule = _classThis;
})();
