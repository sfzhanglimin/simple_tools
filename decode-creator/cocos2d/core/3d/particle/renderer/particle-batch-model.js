...
const mesh_data_1 = require("../../../mesh/mesh-data");
const renderer = require('../../../renderer');
class ParticleBatchModel {
    constructor() {
        this._capacity = 0;
    ...
    _createParticleData() {
        ...
        if (this._mesh) {
            ...
            let posEle = this._vertFormat.element(gfx_1.default.ATTR_TEX_COORD3);
            let normalEle = this._vertFormat.element(gfx_1.default.ATTR_NORMAL);
            let uvEle = this._vertFormat.element(gfx_1.default.ATTR_TEX_COORD);
            let colorEle = this._vertFormat.element(gfx_1.default.ATTR_COLOR1);
            this._mesh.copyAttribute(0, gfx_1.default.ATTR_POSITION, vbData.buffer, vertSize, posEle.offset);
            this._mesh.copyAttribute(0, gfx_1.default.ATTR_NORMAL, vbData.buffer, vertSize, normalEle.offset);
            this._mesh.copyAttribute(0, gfx_1.default.ATTR_UV0, vbData.buffer, vertSize, uvEle.offset);
            if (!this._mesh.copyAttribute(0, gfx_1.default.ATTR_COLOR, vbData.buffer, vertSize, colorEle.offset)) { // copy mesh color to ATTR_COLOR1
        ...
        let meshData = new mesh_data_1.MeshData();
        ...
        if (CC_JSB && CC_NATIVERENDERER) {
            ...
            let vb = new gfx_1.default.VertexBuffer(renderer.device, this._vertFormat, gfx_1.default.USAGE_DYNAMIC, vbData);
            ...
            this._subMeshes[0] = new input_assembler_1.default(vb, ib);
        }
    }
    createTrailData(vfmt, num) {
        ...
        if (CC_JSB && CC_NATIVERENDERER) {
            ...
            let vb = new gfx_1.default.VertexBuffer(renderer.device, vfmt, gfx_1.default.USAGE_DYNAMIC, vBuffer);
            let ib = new gfx_1.default.IndexBuffer(renderer.device, gfx_1.default.INDEX_FMT_UINT16, gfx_1.default.USAGE_DYNAMIC, ibData, num * 6);
            this._subMeshes[1] = new input_assembler_1.default(vb, ib);
        }
    }
