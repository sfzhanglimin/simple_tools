...
cc.Rotate3DTo = cc.Class({
    ...
    initWithDuration: function (duration, dstAngleX, dstAngleY, dstAngleZ) {
        if (cc.ActionInterval.prototype.initWithDuration.call(this, duration)) {
            ...
            if (dstAngleX instanceof cc.Quat) {
                ...
                quat_1.default.fromEuler(dstQuat, dstAngleX, dstAngleY, dstAngleZ);
            }
            return true;
        }
        return false;
    ...
    update: function (dt) {
        ...
        if (this.target) {
            quat_1.default.slerp(_quat_tmp, this._startQuat, this._dstQuat, dt);
...
cc.Rotate3DBy = cc.Class({
    ...
    initWithDuration: function (duration, deltaAngleX, deltaAngleY, deltaAngleZ) {
        if (cc.ActionInterval.prototype.initWithDuration.call(this, duration)) {
            ...
            vec3_1.default.set(this._deltaAngle, deltaAngleX, deltaAngleY, deltaAngleZ);
            return true;
        }
        return false;
    },
    ...
    startWithTarget: function (target) {
        ...
        quat_1.default.fromEuler(this._dstQuat, startAngle.x + deltaAngle.x, startAngle.y + deltaAngle.y, startAngle.z + deltaAngle.z);
        this._startQuat.set(target.quat);
    },
    update: (function () {
        let RAD = Math.PI / 180;
