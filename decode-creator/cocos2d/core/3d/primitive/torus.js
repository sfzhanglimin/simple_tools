 ...
 */
function default_1(radius = 0.4, tube = 0.1, opts = { radialSegments: 32, tubularSegments: 32, arc: 2.0 * Math.PI }) {
    ...
    let uvs = [];
    let indices = [];
    let minPos = new value_types_1.Vec3(-radius - tube, -tube, -radius - tube);
    let maxPos = new value_types_1.Vec3(radius + tube, tube, radius + tube);
