...
exports.calcNormals = exports.normals = exports.toWavefrontOBJ = exports.invWinding = exports.wireframe = void 0;
...
function calcNormals(positions, indices, normals) {
    ...
    for (let i = 0, il = indices.length; i < il; i += 3) {
        ...
        vec3_1.default.subtract(cb, pC, pB);
        vec3_1.default.subtract(ab, pA, pB);
        vec3_1.default.cross(cb, cb, ab);
        normals[vA] += cb.x;
        normals[vA + 1] += cb.y;
        normals[vA + 2] += cb.z;
        normals[vB] += cb.x;
