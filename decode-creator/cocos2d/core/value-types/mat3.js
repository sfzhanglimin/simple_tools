...
class Mat3 {
    ...
    static invert(out, a) {
        let am = a.m, outm = out.m;
        let a00 = am[0], a01 = am[1], a02 = am[2], a10 = am[3], a11 = am[4], a12 = am[5], a20 = am[6], a21 = am[7], a22 = am[8];
    ...
    static fromViewUp(out, view, up) {
        let _fromViewUpIIFE = (function () {
            let default_up = new vec3_1.default(0, 1, 0);
            let x = new vec3_1.default();
            let y = new vec3_1.default();
