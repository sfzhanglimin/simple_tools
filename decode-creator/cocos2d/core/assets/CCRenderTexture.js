...
let DepthStencilFormat = cc.Enum({
     ...
     * @type {number}
     */
    RB_FMT_D24S8: gfx_1.default.RB_FMT_D24S8,
    /**
     ...
     * @type {number}
     */
    RB_FMT_S8: gfx_1.default.RB_FMT_S8,
    /**
     ...
     * @type {number}
     */
    RB_FMT_D16: gfx_1.default.RB_FMT_D16
});
/**
...
let RenderTexture = cc.Class({
    ...
    initWithSize(width, height, depthStencilFormat) {
        ...
        if (depthStencilFormat) {
            depthStencilBuffer = new gfx_1.default.RenderBuffer(renderer.device, depthStencilFormat, width, height);
            if (depthStencilFormat === gfx_1.default.RB_FMT_D24S8) {
                opts.depthStencil = depthStencilBuffer;
            }
            else if (depthStencilFormat === gfx_1.default.RB_FMT_S8) {
                opts.stencil = depthStencilBuffer;
            }
            else if (depthStencilFormat === gfx_1.default.RB_FMT_D16) {
        ...
        this._framebuffer = new gfx_1.default.FrameBuffer(renderer.device, width, height, opts);
    ...
    drawTextureAt(texture, x, y) {
        if (!texture._image || texture._image.width === 0)
            return;
